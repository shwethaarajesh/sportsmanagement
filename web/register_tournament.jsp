...
String sql ="select * from tournament,sports_club where tournament.club_id=id ;";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){  
%>

<tr>
<td><%=resultSet.getInt("tournament_id") %></td>
...
<h1>Remove club</h1>
        <h3>Enter details</h3>
        <form action="register_tournament" method="post">
            <div>Tournament id</div>
            <input type="number" name="tid" placeholder="Tournament id">
