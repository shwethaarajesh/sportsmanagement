...
String sql ="select court_id from courts where school_id='"+sid+"' and sports_id='"+cid+"' ;";
resultSet = statement.executeQuery(sql);
//while(resultSet.next()){
if(!resultSet.isBeforeFirst())
{
%>
<div>No courts are available </div>
            <%
                }
else{
                %>
<h3>Enter details</h3>
        <form action="bookcourt" method="post">
            <div>Book court number </div>
