...
String sql ="select * from tournament,tournament_registration where tournament.club_id='"+cid+"' and tournament.tournament_id=tournament_registration.tournament_id and school_id='"+sid+"';";
resultSet = statement.executeQuery(sql);
    if(!resultSet.isBeforeFirst())
    {
    %>
    <div> No tournaments registered yet </div>
    <% }
    else
{   
%>
