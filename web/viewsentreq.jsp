...
String sql ="select practice_request.court_id,date,time,school.name,sport_name from practice_request,courts,school where courts.court_id=practice_request.court_id and sports_id='"+cid+"' and requestingschool_id='"+sid+"' and acceptingschool_id=school.school_id ;";
