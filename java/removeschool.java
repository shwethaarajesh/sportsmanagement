 ...
 * @author shwet
 */
public class removeschool extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            stmt.executeUpdate("delete from school where school_id='"+sid+"';");
            out.println("Deleted");
            ...
            Logger.getLogger(removeschool.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
